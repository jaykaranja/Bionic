    ...
    <div className="flex items-center justify-center w-full h-full">
        <div className='w-[35%] h-max py-8 px-14 border-2 rounded-3xl flex flex-col items-center gap-4'>
            <div className="flex flex-col gap-2 items-center">
                ...
                <p className="font-bold text-sm text-secondary/55 text-center w-3/4">
            ...
            <div className="flex gap-2 w-full">
                <button onClick={() => navigate('/authentication/sign-in')} className="text-dark border-2 px-6 py-2 w-3/4 rounded-md">Existing user?</button>
